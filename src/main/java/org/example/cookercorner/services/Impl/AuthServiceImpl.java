...
import org.example.cookercorner.exceptions.UserRoleNotFoundException;
...
public class AuthServiceImpl implements AuthService {
    ...
    public String createNewUser(UserRequestDto registrationUserDto) {
        ...
        userRepository.save(userMapper.toEntity(registrationUserDto, userRole, passwordEncoder));
